...
public class CANMetricsReporterImpl implements CANMetricsReporter {
    ...
    private final Logger logger = LoggerFactory.getLogger(CANMetricsReporterImpl.class);
    ...
    public void processFrame(final String source, final CANFrame frame) {
        ...
        switch (CANFrame.FrameType.forValue(frame.getFrameId())) {
            ...
            case SI_ID_FRAME:
                ...
                updateGauge("SISwVer", extraTags, idFrame.getSwVer());
                updateGauge("SIHwVer", extraTags, idFrame.getHwVer());
    ...
    private void updateGauge(final String name, final List<Tag> tags, final Number value) {
    ...
    static class MutableDouble extends Number {
        ...
        MutableDouble(final Number n) {
            setNumber(n);
        }

        MutableDouble(final double doubleValue) {
